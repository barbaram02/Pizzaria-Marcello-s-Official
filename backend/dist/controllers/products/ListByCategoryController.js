...
class ListByCategoryController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const category_id = req.query.category_id; //Um campo vindo dos parâmetros de query string da URL.
            //Inicializando o service
            const listByCategoryService = new ListByCategoryService_1.ListByCategoryService();
            const productbycategory = yield listByCategoryService.execute({
                category_id
            });
